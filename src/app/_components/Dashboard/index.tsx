...
export function Dashboard() {
    return (
        ...
        <div className='grid grid-rows-2' >
            <div>
                <div className='w-full h-[200px] grid grid-cols-1 md:grid-cols-2  ' >
                    <div className='border col-span-2 md:col-span-1' >Carousel</div>
            ...
            <div>
                <div className='w-full h-[200px] grid grid-cols-6' >
