      ...
      <div className="w-full h-full flex  gap-0.5 ">
        ...
        <div className="radial_gradient border-[4px] border-black  overflow-hidden  bg-black grid rounded-md relative grid-row-3 p-1 flex-1 gap-1">
          ...
          <div
            ...
            className={cn(
              luckGuy.className,
              "text-center font-mono  font-extrabold text-4xl md:text-4xl -rotate-[20deg] ",
              data.result === "Win" ? "text-[#00FF00]" : "text-red-600"
            )}
          >
            {data?.result}
          </div>
...
export function ChessPiece() {
  return <div className="relative h-full  w-full">chess piece</div>;
}
